...
<div class="ht__bradcaump__area" style="background: rgba(0, 0, 0, 0) url(<?= base_url('assets/images/bg/7.jpg')?>) no-repeat scroll center center / cover ;">
                        ...
                        <div class="col-12">
                            <div class="bradcaump__inner text-center">
                                ...
                                <nav class="bradcaump-inner">
                                  <a class="breadcrumb-item" href="<?= base_url('index.php/main')?>">Home</a>
                ...
                <div class="row team__wrap clearfix mt--60">
                    ...
                    <div class="col-md-4 col-lg-4 col-sm-12 xmt-30">
                        <div class="team foo">
                            <div class="team__thumb">
                                <a href="#">
                                    <img src="<?= base_url('assets/images/team/2.jpg')?>" alt="team images">
                                </a>
                            </div>
                            <div class="team__bg__color"></div>
                            <div class="team__hover__info">
                    ...
                    <div class="col-md-4 col-lg-4 hidden-sm col-xs-12 xmt-30">
                        <div class="team foo">
                            <div class="team__thumb">
                                <a href="#">
                                    <img src="<?= base_url('assets/images/team/4.jpg')?>" alt="team images">
                                </a>
                            </div>
                            <div class="team__bg__color"></div>
                            <div class="team__hover__info">
        ...
        <div class="htc__testimonial__area ptb--120" style="background: rgba(0, 0, 0, 0) url(<?= base_url('assets/images/bg/fa.jpg')?>) no-repeat scroll center center / cover ;" data--black__overlay="6">
            <div class="container">
                <div class="row">
                        ...
                        <div class="testimonial__wrap owl-carousel owl-theme clearfix">
                            ...
                            <div class="testimonial">
                                <div class="testimonial__thumb">
                                    <img src="<?= base_url('assets/images/test/client/1.png')?>" alt="testimonial images">
                                </div>
                            ...
                            <div class="testimonial">
                                <div class="testimonial__thumb">
                                    <img src="<?= base_url('assets/images/test/client/2.png')?>" alt="testimonial images">
                                </div>
                                <div class="testimonial__details">
                                    <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit sed do eiusmod teincidi dunt ut labore et dolore gna aliqua. Ut enim ad minim veniam,</p>
                                    <div class="test__info">
                            ...
                            <div class="testimonial">
                                <div class="testimonial__thumb">
                                    <img src="<?= base_url('assets/images/test/client/3.png')?>" alt="testimonial images">
                                </div>
                                <div class="testimonial__details">
                                    <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit sed do eiusmod teincidi dunt ut labore et dolore gna aliqua. Ut enim ad minim veniam,</p>
                                    <div class="test__info">
                                        <span><a href="#">Amet Sumemet</a></span>
                                        <span> - </span>
                                        <span>Customer</span>
                                    </div>
                                </div>
                ...
                <div class="row">
                    <div class="col-md-12">
                        <ul class="brand__list">
                            <li><a href="#">
                                <img src="<?= base_url('assets/images/brand/1.png')?>" alt="brand images">
                            </a></li>
                            <li><a href="#">
                                <img src="<?= base_url('assets/images/brand/2.png')?>" alt="brand images">
                            </a></li>
                            <li><a href="#">
                                <img src="<?= base_url('assets/images/brand/3.png')?>" alt="brand images">
                            </a></li>
                            <li><a href="#">
                                <img src="<?= base_url('assets/images/brand/4.png')?>" alt="brand images">
                            </a></li>
                            <li class="hidden-sm"><a href="#">
                                <img src="<?= base_url('assets/images/brand/5.png')?>" alt="brand images">
                            </a></li>
                        </ul>
                    </div>
                </div>
