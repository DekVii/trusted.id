                ...
                <div class="row team__wrap clearfix">
                    ...
                    <div class="col-md-6 col-lg-4 col-sm-12">
                        <div class="team foo">
                            <div class="team__thumb">
                                <a href="#">
                                    <img src="<?php echo base_url('assets/images/team/1.jpg') ?>" alt="team images">
                                </a>
                            </div>
                    ...
                    <div class="col-md-6 col-lg-4 col-sm-12">
                        <div class="team foo">
                            <div class="team__thumb">
                                <a href="#">
                                    <img src="<?php echo base_url('assets/images/team/2.jpg') ?>" alt="team images">
                                </a>
                            </div>
                            <div class="team__bg__color"></div>
                            <div class="team__hover__info">
                    ...
                    <div class="col-md-6 col-lg-4 col-sm-12">
                        <div class="team foo">
                            <div class="team__thumb">
                                <a href="#">
                                    <img src="<?php echo base_url('assets/images/team/4.jpg') ?>" alt="team images">
                                </a>
                            </div>
                            <div class="team__bg__color"></div>
                            <div class="team__hover__info">
                        ...
                        <div class="testimonial__wrap owl-carousel owl-theme clearfix">
                            ...
                            <div class="testimonial">
                                <div class="testimonial__thumb">
                                    <img src="<?php echo base_url('assets/images/test/client/1.png') ?>" alt="testimonial images">
                                </div>
                            ...
                            <div class="testimonial">
                                <div class="testimonial__thumb">
                                    <img src="<?php echo base_url('assets/images/test/client/2.png') ?>" alt="testimonial images">
                                </div>
                                <div class="testimonial__details">
                                    <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit sed do eiusmod teincidi dunt ut labore et dolore gna aliqua. Ut enim ad minim veniam,</p>
                                    <div class="test__info">
                            ...
                            <div class="testimonial">
                                <div class="testimonial__thumb">
                                    <img src="<?php echo base_url('assets/images/test/client/3.png') ?>" alt="testimonial images">
                                </div>
                                <div class="testimonial__details">
                                    <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit sed do eiusmod teincidi dunt ut labore et dolore gna aliqua. Ut enim ad minim veniam,</p>
                                    <div class="test__info">
                                        <span><a href="#">Amet suprati</a></span>
                                        <span> - </span>
                                        <span>Customer</span>
                                    </div>
                                </div>
