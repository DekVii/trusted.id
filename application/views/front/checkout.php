                        ...
                        <div class="ckeckout-left-sidebar">
                            ...
                            <div class="our-payment-sestem">
                                ...
                                <ul class="payment-menu">
                                    <li><a href="#"><img src="<?= base_url('assets/images/payment/1')?>.jpg" alt="payment-img"></a></li>
                                    <li><a href="#"><img src="<?= base_url('assets/images/payment/2')?>.jpg" alt="payment-img"></a></li>
                                    <li><a href="#"><img src="<?= base_url('assets/images/payment/3')?>.jpg" alt="payment-img"></a></li>
                                    <li><a href="#"><img src="<?= base_url('assets/images/payment/4')?>.jpg" alt="payment-img"></a></li>
                                    <li><a href="#"><img src="<?= base_url('assets/images/payment/5')?>.jpg" alt="payment-img"></a></li>
                                </ul>
