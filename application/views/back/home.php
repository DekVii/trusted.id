...
<!-- End Bradcaump area -->
 ...
 <section class="htc__product__area bg__white ptb--130">
            ...
            <div class="d-sm-flex align-items-center justify-content-between mb-4">
                ...
                <a href="<?= base_url('index.php/auth/logout')?>" class="d-none d-sm-inline-block btn btn-sm btn-primary shadow-sm"><i class="fas fa-download fa-sm text-white-50"></i>Logout</a></a>
            </div>
